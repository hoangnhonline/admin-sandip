...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      @endif
      <a href="{{ route('event.create', ['cate_id' => $cate_id]) }}" class="btn btn-info btn-sm" style="margin-bottom:5px">Add new</a>
      ...
      <div class="box">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">List ( <span class="value">{{ $items->total() }} sự kiện )</span></h3>
        </div>
